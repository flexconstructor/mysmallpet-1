...
$MESS["WIZ_COMPANY_NAME_DEF"] = "Интернет-магазин PetHouse";
...
$MESS["WIZ_COMPANY_COPY_DEF"] = "&copy; PetHouse. Информация сайта защищена законом об авторских правах.";
...
$MESS["WIZ_SHOP_OF_NAME_DEF"] = "ООО \"PetHouse\"";
$MESS["WIZ_SHOP_OF_NAME_DEF_UA"] = "ТОВ \"PetHouse\"";
...
$MESS["WIZ_SHOP_PRICE_BASE_TEXT1"] = "В решении \"PetHouse\" используется в качестве публичных цен для просмотра и покупки базовая цена (BASE). В текущий момент для группы \"Все пользователи (в том числе неавторизованные)\" включено право на данный тип цены. Таким образом данная группа будет видеть цены в решении.";
...
$MESS["wiz_keywords"] = "товары для животных, одежда для животных, корм для животных, игрушки для животных";
