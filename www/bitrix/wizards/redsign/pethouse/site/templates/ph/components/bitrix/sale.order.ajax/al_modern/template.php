...
else
{
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row sline-order" style="opacity: 0">
			<!--	MAIN BLOCK	-->
			<div class="col col-sm-9">
				...
				<div id="bx-soa-region" data-visited="false" class="order-section bx-soa-section bx-active">
					<div class="order-section__title bx-soa-section-title-container">
						<h2 class="bx-soa-section-title col-sm-9">
							<svg class="icon-svg order-section__icon"><use xlink:href="#svg-marker"></use></svg>
							<svg class="icon-svg order-section__icon"><use xlink:href="#svg-check"></use></svg>
							<svg class="icon-svg order-section__icon"><use xlink:href="#svg-error"></use></svg>
				...
				<!--	ORDER SAVE BLOCK	-->
				<div id="bx-soa-orderSave" class="clearfix">
