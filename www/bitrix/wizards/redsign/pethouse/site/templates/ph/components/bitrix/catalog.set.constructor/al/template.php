...
$arBuy1click = array(
    'RS_EXT_FIELD_0' => '['.$arResult['ELEMENT']['ID'].'] '.htmlspecialcharsbx($arResult['ELEMENT']['NAME']),
    'RS_ORDER_IDS' => $arResult['ELEMENT']['ID'],
);
?>
...
<div id="bx-set-const-<?=$curJsId?>" class="bx-modal-container container-fluid">
    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="bx-original-item-container catalog_item js-main-elem-set" data-id="<?=$arResult['ELEMENT']['ID']?>" data-elemmain="<?='['.$arResult['ELEMENT']['ID'].'] '.$arResult['ELEMENT']['NAME'].'; ';?>">
                <div class="catalog_item__inner">
                    ...
                    <div class="catalog_item__head">
                        ...
                        <div class="catalog_item__brand b-text_fade">
                            <?=GetMessage('RS_SLINE.BCSC_AL.MEASURE_NUM')?><?=$arResult["ELEMENT"]["BASKET_QUANTITY"];?> <?=$arResult["ELEMENT"]["MEASURE"]["SYMBOL_RUS"];?>
                        </div>
                    </div>
        ...
        <div class="col-sm-6">
            <div class="bx-added-item-table-container">
                <table class="bx-added-item-table">
                    ...
                    <?foreach($arResult["SET_ITEMS"]["DEFAULT"] as $key => $arItem):?>
                        ...
                        >
                            ...
                            <td class="bx-added-item-table-cell-itemname">
                                ...
                                <?=GetMessage('RS_SLINE.BCSC_AL.MEASURE_NUM')?><?=$arItem["BASKET_QUANTITY"];?> <?=$arItem["MEASURE"]["SYMBOL_RUS"];?>
                            </td>
                    ...
                    <?php
                    $arBuy1click['RS_EXT_FIELD_0'] .= '['.$arItem['ID'].'] '.htmlspecialcharsbx($arItem['NAME']);
                    $arBuy1click['RS_ORDER_IDS'] .= ','.$arItem['ID'];
        ...
        <div class="col-sm-3">
            <div class="bx-constructor-container-result detail__buy">
                ...
                <div class="detail__btns">
                    <a href="javascript:void(0)" data-role="set-buy-btn" class="detail__btn add2cart btn add2cart js-add2cart">
                        <svg class="icon icon-cart icon-svg"><use xlink:href="#svg-cart"></use></svg>
                        <?=GetMessage("CATALOG_SET_BUY")?>
                    </a>
                    <?php if ($arParams['USE_BUY1CLICK'] == 'Y'): ?>
                        <a class="detail__btn btn buy1click js-ajax_link"
                            data-fancybox="buy1click-set" data-type="ajax"
                            data-insert_data="<?=htmlspecialcharsbx(\Bitrix\Main\Web\Json::encode($arBuy1click))?>"
                            href="<?=SITE_DIR?>buy1click/"
                            title="<?=Loc::getMessage('RS_SLINE.BCSC_AL.MESS_BTN_BUY1CLICK')?>"
                            rel="nofollow"
                        >
                              <svg class="icon icon-phone icon-svg"><use xlink:href="#svg-phone-big"></use></svg>
                              <?=GetMessage('RS_SLINE.BCSC_AL.MESS_BTN_BUY1CLICK')?>                               
                        </a>
                    <?php endif; ?>
                </div>
                <div class="show_more_set">
                    <span class="anchor"><?=GetMessage('RS_SLINE.BCSC_AL.DO_OUR_SET');?></span><svg class="icon icon-right icon-svg"><use xlink:href="#svg-right"></use></svg>
                </div>
            </div>
        </div>
    </div>
                ...
                >
                    <div class="bx-catalog-set-item">
                        ...
                        <div class="bx-catalog-set-item-add-btn">
                            ...
                            if ($arItem['CAN_BUY'])
                            {
                                ?><a href="javascript:void(0)" data-role="set-add-btn" class="btn-add catalog_item__add2cart btn btn-default add2cart"><?= GetMessage("CATALOG_SET_BUTTON_ADD") ?></a><?
                            }
                            else
                            {
...
$arJsParams = array(
    ...
    "messages" => array(
        ...
        "MEASURE_NUM" => GetMessage('RS_SLINE.BCSC_AL.MEASURE_NUM')
    )
);
?>
