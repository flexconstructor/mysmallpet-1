...
if (Loader::includeModule('redsign.pethouse'))
{
...
if ($arResult['ShowReady'] == 'Y')
{
    foreach ($arResult["GRID"]["ROWS"] as $k => $arItem)
	{
        ...
        $arResult['BUY1CLICK']['ITEMS'][$arItem['ID']] = $arItem['PRODUCT_ID'];
        $arResult['BUY1CLICK']['STRING'] .= '['.$arItem['ID'].'] '.$arItem['NAME'].', ';
    }
}