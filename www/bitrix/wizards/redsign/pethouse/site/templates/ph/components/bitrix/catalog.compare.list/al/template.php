...
<div class="cmp_items__body">
    <ul id="<? echo $idCompareTable; ?>" class="cmp_items__list">
        <?php
        $arrIDs = array();
        foreach($arResult as $arElement):
            $arrIDs[$arElement['ID']] = true;
        ?>
            <li class="cmp_items__item" id="<? echo $idCompareRow.$arElement['PARENT_ID']; ?>">
                <a class="cmp_items__pic" href="<?=$arElement["DETAIL_PAGE_URL"]?>" itemscope itemtype="https://schema.org/ImageObject">
                ...
                <!--noindex-->
                    <a class="cmp_items__del" href="javascript:void(0);"  data-id="<? echo $arElement['PARENT_ID']; ?>" rel="nofollow">
