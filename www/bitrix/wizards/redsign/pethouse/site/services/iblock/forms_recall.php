...
if(COption::GetOptionString("redsign.master", "wizard_installed", "N", WIZARD_SITE_ID) == "Y" && !WIZARD_INSTALL_DEMO_DATA){
	if($wizard->GetVar('rewriteIndex', true) && $wizard->GetVar('siteLogoSet', true)){
		$iblockCode = "pethouse_forms_recall_".WIZARD_SITE_ID;
		$iblockType = "forms";
		...
		{
            CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/include/forms/recall/index.php", array("FORMS_RECALL_IBLOCK_ID" => $iblockID));
		}
	}
	return;
}
...
WizardServices::IncludeServiceLang("recall.php", $lang);
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/recall/index.php", array("FORMS_RECALL_IBLOCK_ID" => $iblockID));
?>