	...
	<?if(strlen($arResult["ERROR_MESSAGE"])<=0):?>
		<form method="post" action="<?=POST_FORM_ACTION_URI?>">
			...
			<div class="form-group">
                <textarea class="form-control" name="REASON_CANCELED" placeholder="<?=GetMessage('SALE_CANCEL_ORDER4')?>:"></textarea>
            </div>
			<input class="btn btn-default" type="submit" name="action" value="<?=GetMessage("SALE_CANCEL_ORDER_BTN") ?>">
