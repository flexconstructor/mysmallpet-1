...
if($arResult['HAS_MAIN_PRODUCTS'])
{
	...
	?>
	<? /*if(empty($arParams['HIDE_BLOCK_TITLE']) || $arParams['HIDE_BLOCK_TITLE'] !== 'Y'){ ?><h2 class="bx_item_list_title"><? echo ($arParams['BLOCK_TITLE']? htmlspecialcharsbx($arParams['BLOCK_TITLE']) : GetMessage('SLB_TPL_TITLE_GIFT')) ?></h2><? } */?>
	<?
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			"SECTION_TITLE" => (empty($arParams['HIDE_BLOCK_TITLE']) || $arParams['HIDE_BLOCK_TITLE'] !== 'Y'
				? $arParams['BLOCK_TITLE']
					? htmlspecialcharsbx($arParams['BLOCK_TITLE'])
					: GetMessage('SLB_TPL_TITLE_GIFT')
				: ''),
		),
		$component,
		array('HIDE_ICONS' => 'Y')
