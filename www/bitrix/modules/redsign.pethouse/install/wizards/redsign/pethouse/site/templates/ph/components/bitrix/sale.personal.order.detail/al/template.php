...
?>
							...
							<div class="row">
								...
								if ($arParams['GUEST_MODE'] !== 'Y')
								{
									...
									<div class="col-md-2 col-sm-6 sale-order-detail-about-order-inner-container-repeat">
										<a href="<?=$arResult["URL_TO_COPY"]?>" class="btn btn-default sale-order-detail-about-order-inner-container-repeat-button">
										...
										{
											?>
											<a href="<?=$arResult["URL_TO_CANCEL"]?>" class="btn sale-order-detail-about-order-inner-container-repeat-cancel">
		...
		<div class="panel sale-order-detail-payment-options">
			<div class="panel__head">
				<h3 class="sale-order-detail-payment-options-title-element">
					<?=Loc::getMessage('SPOD_ORDER_PAYMENT')?>
				</h3>
			</div>
			<div class="panel__body sale-order-detail-payment-options-container">
												...
												<div class="row sale-order-detail-payment-options-methods-information-block">
													...
													if ($payment['PAY_SYSTEM']["IS_CASH"] !== "Y")
													{
														...
														<div class="col-md-2 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods-button-container">
															...
															{
																?>
																<a class="btn btn-default sale-order-detail-payment-options-methods-button-element-new-window"
																   target="_blank"
															...
															else
															{
																...
																{
																	?>
																	<a class="btn btn-default disabled sale-order-detail-payment-options-methods-button-element inactive-button"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></a>
																	<?
																}
																else
																{
																	?>
																	<a class="btn btn-default sale-order-detail-payment-options-methods-button-element active-button"><?= Loc::getMessage('SPOD_ORDER_PAY') ?></a>
																	<?
																}
															}
															?>
