...
if(COption::GetOptionString("redsign.pethouse", "wizard_installed", "N", WIZARD_SITE_ID) == "N" || WIZARD_INSTALL_DEMO_DATA)
{
	...
	COption::SetOptionString("redsign.pethouse", "template_converted", "Y", "", WIZARD_SITE_ID);
}
elseif (COption::GetOptionString("redsign.pethouse", "template_converted", "N", WIZARD_SITE_ID) == "N")
{
	CopyDirFiles(
	...
	CopyDirFiles(
		WIZARD_SITE_PATH."/include/company_logo2.php",
		WIZARD_SITE_PATH."/include/company_logo2_old.php",
		$rewrite = true,
		$recursive = true,
		$delete_after_copy = true
	);
...
if (CModule::IncludeModule("sale"))
{
	$addResult = \Bitrix\Main\UserConsent\Internals\AgreementTable::add(array(
		...
		"CODE" => "sale_default",
		"NAME" => GetMessage("REDSIGN.USER_CONSENT_NAME"),
		"TYPE" => \Bitrix\Main\UserConsent\Agreement::TYPE_CUSTOM,
		"LANGUAGE_ID" => LANGUAGE_ID,
		"AGREEMENT_TEXT" => GetMessage("REDSIGN.AGREEMENT_TEXT"),
		"LABEL_TEXT" => GetMessage("REDSIGN.AGREEMENT_LABEL_TEXT", array("#URL#" => WIZARD_SITE_DIR."licenses/personal.php")),
		"DATA_PROVIDER" => \Bitrix\Sale\UserConsent::DATA_PROVIDER_CODE,
	));
	if ($addResult->isSuccess())
	{
		CWizardUtil::ReplaceMacros(
			WIZARD_SITE_PATH."buy1click/index.php",
		...
		CWizardUtil::ReplaceMacros(
			WIZARD_SITE_PATH."feedback/index.php",
			array("USER_CONSENT_ID" => $addResult->getId())
		);
		CWizardUtil::ReplaceMacros(
		...
		CWizardUtil::ReplaceMacros(
			WIZARD_SITE_PATH."personal/subscriptions/index.php",
			array("USER_CONSENT_ID" => $addResult->getId())
		);
		CWizardUtil::ReplaceMacros(
			WIZARD_SITE_PATH."recall/index.php",
			array("USER_CONSENT_ID" => $addResult->getId())
		);
	}
}
