...
<?php endif; ?>
	...
	<p>
        <button class="btn btn-default" type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>">
        ...
        <input class="btn btn-grey" type="reset" value="<?=GetMessage('MAIN_RESET');?>">
    </p>
</form>
<?
