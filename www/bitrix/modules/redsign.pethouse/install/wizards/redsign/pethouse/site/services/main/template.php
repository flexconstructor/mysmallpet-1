...
*/
if (!in_array($wizrdTemplateId, array("ph")))
	$wizrdTemplateId = "ph";
...
if($logo || $logoRetina)
{
    ...
    ___writeToAreasFile(WIZARD_SITE_PATH."include/company_logo2.php", $content);
...
{
	copy(WIZARD_ABSOLUTE_PATH."/site/templates/ph/assets/img/logo.png", WIZARD_SITE_PATH."include/logo.png");
	copy(WIZARD_ABSOLUTE_PATH."/site/templates/ph/assets/img/logo_retina.png", WIZARD_SITE_PATH."include/logo_retina.png");
	...
	___writeToAreasFile(WIZARD_SITE_PATH."include/company_logo2.php", '<img src="'.WIZARD_SITE_DIR.'include/logo.png" srcset="'.WIZARD_SITE_DIR.'include/logo_retina.png 2x">');
}
