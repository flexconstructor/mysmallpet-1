...
abstract class PropertyValueBase extends Internals\CollectableEntity
{
	...
	public static function loadForOrder(OrderBase $order)
	{
		...
		$dbRes = $propertyClassName::getList([
			'select' => ['ID', 'PERSON_TYPE_ID', 'NAME', 'TYPE', 'REQUIRED', 'DEFAULT_VALUE', 'SORT',
		...
		$propRelation = Internals\OrderPropsRelationTable::getRelationsByPropertyIdList(array_keys($properties));
