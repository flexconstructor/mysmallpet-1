...
Class redsign_quickbuy extends CModule
{
	...
	function redsign_quickbuy()
	{
		...
		$this->MODULE_NAME = GetMessage("RS_QB_INSTALL_NAME");
		$this->MODULE_DESCRIPTION = GetMessage("RS_QB_INSTALL_DESCRIPTION");
		$this->PARTNER_NAME = GetMessage("RS_QB_SPER_PARTNER");
		$this->PARTNER_URI = GetMessage("RS_QB_PARTNER_URI");
	}
	...
	function DoInstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("RS_QB_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/redsign.quickbuy/install/install.php");
	}
	...
	function DoUninstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("RS_QB_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/redsign.quickbuy/install/uninstall.php");
	}
}