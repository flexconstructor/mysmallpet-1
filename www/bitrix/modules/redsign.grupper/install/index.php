...
Class redsign_grupper extends CModule
{
	...
	function redsign_grupper()
	{
		...
		$this->MODULE_NAME = GetMessage("RS_GRUPPER_INSTALL_NAME");
		$this->MODULE_DESCRIPTION = GetMessage("RS_GRUPPER_INSTALL_DESCRIPTION");
		$this->PARTNER_NAME = GetMessage("RS_GRUPPER_SPER_PARTNER");
		$this->PARTNER_URI = GetMessage("RS_GRUPPER_PARTNER_URI");
	}
	...
	function DoInstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("RS_GRUPPER_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/redsign.grupper/install/install.php");
	}
	...
	function DoUninstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("RS_GRUPPER_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/redsign.grupper/install/uninstall.php");
	}
}
?>