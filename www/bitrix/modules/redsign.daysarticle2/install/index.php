...
Class redsign_daysarticle2 extends CModule
{
	...
	function redsign_daysarticle2()
	{
		...
		$this->MODULE_NAME = GetMessage("RS_DA2_INSTALL_NAME");
		$this->MODULE_DESCRIPTION = GetMessage("RS_DA2_INSTALL_DESCRIPTION");
		$this->PARTNER_NAME = GetMessage("RS_DA2_SPER_PARTNER");
		$this->PARTNER_URI = GetMessage("RS_DA2_PARTNER_URI");
	}
	...
	function DoInstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("RS_DA2_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/redsign.daysarticle2/install/install.php");
	}
	...
	function DoUninstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("RS_DA2_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/redsign.daysarticle2/install/uninstall.php");
	}
}
?>