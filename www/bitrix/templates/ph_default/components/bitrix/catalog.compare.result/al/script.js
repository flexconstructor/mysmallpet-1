...
BX.Iblock.Catalog.CompareClass = (function()
{
  ...
  CompareClass.prototype.setRhythm = function()
  {
    var wrapObj = BX(this.wrapObjId),
      ...
      rowsData =  BX.findChildren(tableItems, {'class': 'compare__row'}, true);
      rowsName =  BX.findChildren(BX.findChild(wrapObj , {'class': 'cmp_page__names'}, true), {'class': 'compare__row'}, true);
