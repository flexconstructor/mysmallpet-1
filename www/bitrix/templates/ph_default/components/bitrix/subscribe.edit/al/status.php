...
<div class="panel">
    ...
    <?if($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y"):?>
		...
		<?if($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y"):?>
			<input class="btn btn-default" type="submit" name="unsubscribe" value="<?echo GetMessage("subscr_unsubscr")?>" />
			<input type="hidden" name="action" value="unsubscribe" />
		<?else:?>
			<input class="btn btn-default" type="submit" name="activate" value="<?echo GetMessage("subscr_activate")?>" />
