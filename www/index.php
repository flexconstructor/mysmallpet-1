...
?>
<div class="l-home_tabs"<?php $APPLICATION->ShowViewContent('home-tabs'); ?>>
    <div class="container">
...
// $APPLICATION->ShowViewContent('main_section_tab');
        ...
        <div class="tab-content">
			<?php // include($_SERVER['DOCUMENT_ROOT'].SITE_DIR.'include/index/section_list.php'); ?>
            <?php include($_SERVER['DOCUMENT_ROOT'].SITE_DIR.'include/index/brands.php'); ?>
        </div>
    </div>
</div>
<?
if (!$bRSHomeTabShow) {
    $APPLICATION->AddViewContent('home-tabs', ' style="display: none"');
}
?>
<div class="container">
    <div class="row clearfix">
        <div class="l-base col-xs-12 col-md-9 col-lg-9d6">
            ...
            ?>
            <ul role="tablist" class="nav-tabs js-catalog_refresh">
