...
<div class="row">
		...
		<div class="l-base col-xs-12 col-md-9 col-lg-9d6">
			...
			<div class="clearfix">
				...
				<div class="catalog__pagenav catalog__pagenav-top js-catalog_refresh" id="<?=$arParams['CATALOG_TEMPLATE_AJAXID']?>_pager" data-ajax-id="<?=$arParams['CATALOG_TEMPLATE_AJAXID']?>" data-history-push="">
			...
			$arCatalogSectionParams = array(
				...
				"SET_BROWSER_TITLE" => 'N', //$arParams["SET_BROWSER_TITLE"],
				// "MESSAGE_404" => $arParams["MESSAGE_404"],
				// "SET_STATUS_404" => $arParams["SET_STATUS_404"],
				// "SHOW_404" => $arParams["SHOW_404"],
				// "FILE_404" => $arParams["FILE_404"],
