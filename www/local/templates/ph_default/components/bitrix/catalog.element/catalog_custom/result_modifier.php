...
$dbBasketItems = CSaleBasket::GetList(array("NAME" => "ASC","ID" => "ASC"),array("FUSER_ID" => CSaleBasket::GetBasketUserID(),"LID" => SITE_ID,"ORDER_ID" => "NULL"),false,false,array("ID", "MODULE","PRODUCT_ID", "QUANTITY", "DELAY","CAN_BUY", "PRICE", "WEIGHT"));
while ($basket_arItems = $dbBasketItems->Fetch())
{
    $current_basket_items[] = $basket_arItems['PRODUCT_ID'];
}

$arResult['CURRENT_BASKET_ITEMS'] = $current_basket_items;
