...
$MESS["AUTH_FORGOT_PASSWORD_2"] = "Забыли?";
...
$MESS["AUTH_FORGOT_PASSWORD_TITLE"] = "Напомнить пароль";
$MESS["AUTH_BLOCK_TITLE"] = "Авторизация";
$MESS["AUTH_TRUE"] = "Вы успешно зарегистрировались и авторизовались на сайте!";
$MESS["RS_SLINE.BSAF_FANCYBOX.CONTINUE"] = "Продолжить";
?>